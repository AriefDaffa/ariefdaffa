...
const BlogCard: FC<BlogCardProps> = ({ date, desc, image, title, url }) => {
  return (
    <Link
      href={url}
      className="flex gap-4 w-full h-60 cursor-pointer border-b-[1px] border-gray-200 dark:border-gray-600 pb-6"
    >
      <div className="md:w-4/6 flex flex-col justify-between">
        <div>
          ...
          <div className="text-2xl font-bold pt-1 hover:text-primary">
            {title}
          </div>
